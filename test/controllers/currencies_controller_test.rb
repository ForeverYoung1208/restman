...
class CurrenciesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create currency" do
    assert_difference('Currency.count') do
      post currencies_url, params: { currency: { code: @currency.code, name_eng: @currency.name_eng, name_int: @currency.name_int, name_ukr: @currency.name_ukr } }
    end
  ...
  test "should update currency" do
    patch currency_url(@currency), params: { currency: { code: @currency.code, name_eng: @currency.name_eng, name_int: @currency.name_int, name_ukr: @currency.name_ukr } }

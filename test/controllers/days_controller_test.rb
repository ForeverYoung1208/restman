...
class DaysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create day" do
    assert_difference('Day.count') do
      post days_url, params: { day: { comment: @day.comment, date: @day.date, is_closed: @day.is_closed } }
    end
  ...
  test "should update day" do
    patch day_url(@day), params: { day: { comment: @day.comment, date: @day.date, is_closed: @day.is_closed } }
